...
?>
<div id="perfil_docentes" class="row" >
    <div style="background-color: white; width:600px; margin-top:50px;padding:40px; margin-left:8%;">
        <div class="row">
            ...
            <div class="col-md-6">
                <div>
                    <div>
                        <button class="btn btn form-control" id="indice"style="background-color: rgb(11, 11, 53);color:white">Cantidad de Asiganaturas Impartidas</button>
                    </div>
                    <div> <br>
                        <a href="horario_docente.php"><button class="btn btn form-control" style="background-color: rgb(11, 11, 53);color:white"> Horario</button></a>
                    </div>
                    <div><br>
                        <button class="btn btn form-control" id="informacion" style="background-color: rgb(11, 11, 53);color:white">Informacion</button>
                    </div>
                    <div><br>
                        <a href="record_notas.php"><button class="btn btn form-control" style="background-color: rgb(11, 11, 53);color:white">Reconocimiento</button></a>
                    </div>
                    <div><br>
                        <a href="record_notas.php"><button class="btn btn form-control" style="background-color: rgb(11, 11, 53);color:white">Maestros Suplentes</button></a>
                    </div>
                </div>
            </div>
        </div>
