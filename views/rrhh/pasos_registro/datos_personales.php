    ...
    <form action="" method="post">
      <h5> Datos del empleado</h5> 
        <div class="row">
            ...
            <div class="col-md-6"><br>
                <input class="form-control" type="text" placeholder="Departamento" name="" id="" require>
            </div>
            <div class="col-md-6"><br>
                <input class="form-control" type="text" placeholder="Tipo de contrato" name="" id="" require>
            </div>
