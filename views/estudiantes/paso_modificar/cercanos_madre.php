      ...
      <h5> Familiar cercano a la madre </h5> 
        <div class="row">
            <div class="col-md-16"><br>
                <input class="form-control campo" type="text" value="<?php echo $estudiante['cercano_madre']?>" name="" placeholder="Nombre de un familiar cercano al padre" id="" require>
            </div>
            ...
            <div class="col-md-6"><br>
                <a  style="float: right;" class="btn btn-primary " id="siguiente3">Siguiente</a>
            </div>
        </div>
    </div>
</div>