      ...
      <h5> Datos de tutores </h5> 
        <div class="row">
            <div class="col-md-12"><br>
                <input class="form-control" type="text" name="" placeholder="Nombre del padre" id="" require>
            </div>
            <div class="col-md-12"><br>
                <input class="form-control" type="Text" placeholder="Nombre de la madre" name="" id="" require>
            </div>
            ...
            <div  class="col-md-12"><br>
                <textarea class="form-control"  placeholder="Dirección" name="" id="" cols="30" rows="4"></textarea>
            </div>
            <div class="col-md-6"><br>
