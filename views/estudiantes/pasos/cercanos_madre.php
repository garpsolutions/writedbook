      ...
      <h5> Familiar cercano a la madre </h5> 
        <div class="row">
            <div class="col-md-16"><br>
                <input class="form-control" type="text" name="familiar_madre" placeholder="Nombre de un familiar cercano al padre" id="" require>
            </div>
            <div class="col-md-6"><br>
                <input class="form-control" type="text" placeholder="Parentesco" name="parentesco_madre" id="" require>
            </div>
            <div class="col-md-6"><br>
                <input class="form-control" type="Text" placeholder="Dirección" name="direccion_madre" id="" require>
            </div>
            <div class="col-md-6"><br>
